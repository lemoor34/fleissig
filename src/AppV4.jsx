...
export default function AppV4() {
  ...
  return <div id="start"><Header /><main>
    ...
    <Services />
    <section className="review"><div className="shell"><div className="stars">{[1,2,3,4,5].map(n => <Star key={n} size={20} fill="currentColor" />)}</div><blockquote>«Herzlichen Dank, ihr habt super Arbeit geleistet. Ich empfehle euch sehr gerne weiter.»</blockquote><strong>Daniela & Martin</strong></div></section>
