...
function Services() {
  const items = [
    ...
    { icon: Truck, title: "Umzugsreinigung", price: "Preis direkt online berechnen", detail: "Mit Abgabegarantie. Nach dem Foto-Check erhalten Sie den verbindlichen Fixpreis.", cta: "Preis berechnen", href: "/umzugsreinigung-aargau" },
...
export default function AppV4() {
  ...
  return <div id="start"><Header /><main>
    <section className="hero"><div className="shell hero-grid"><div><span className="eyebrow">Reinigung im Kanton Aargau</span><h1>Professionelle Reinigung im Aargau.</h1><p className="lead">Faire Preise ab CHF 55. Direkter Kontakt mit unserem Team im Aargau – per WhatsApp oder Telefon.</p><div className="hero-actions"><WhatsAppButton label="Reinigungstermin anfragen" /><a className="btn btn-secondary" href={`tel:${CONFIG.phone.replace(/\s/g, "")}`} onClick={() => trackLead("phone")}><Phone size={19} /> Anrufen</a></div><small><Clock3 size={15} /> Persönliche Antwort · werktags 8–18 Uhr</small></div><img className="hero-img" src="/hero-clean-bathroom.webp" alt="Sauber gereinigtes Badezimmer" /></div></section>
    <TrustStrip />
