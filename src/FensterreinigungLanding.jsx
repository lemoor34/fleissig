...
*{box-sizing:border-box}body{margin:0}.fw-page{font-family:'Plus Jakarta Sans',sans-serif;color:var(--ink);background:#fff}.fw-shell{width:min(1040px,calc(100% - 36px));margin:auto}
